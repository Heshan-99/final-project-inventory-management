    ...
    <body>
        ...
        <table style="margin-top: -40px;">
            ...
            <tbody>
                ...
                foreach ($data AS $x) {
                    ...
                    echo '<tr>
                                <td>' . $x['supName'] . '</td>
                                <td styles="width:">' . $x['sup_address'] . '</td>
                                <td>' . $x['sup_mobile'] . '</td>
                                <td>' . $x['sup_email'] . '</td>
                                <td></td>
                            </tr>';
        ...
        <table class="balance" style="margin-top: 20px;">
            <tr style="font-size:13px; font-weight: bold">
                <th><span>Total suppliers</span></th>
                <td><span><?php echo $supCount; ?></span></td>
            </tr>
        ...
        <style>
            *
            ...
            table.inventory td:nth-child(1) { width: auto; }
            table.inventory td:nth-child(2) { width: auto; }
            table.inventory td:nth-child(3) { text-align: right; width: auto; }
            table.inventory td:nth-child(4) { text-align: right; width: auto; }
            table.inventory td:nth-child(5) { text-align: right; width: auto; }
