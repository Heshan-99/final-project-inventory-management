...
$q1 = "SELECT
        ...
        WHERE
	    ims_order_summary.order_table_id = '{$orderNo}'";
...
<table style="width: 8cm; border: 1px solid black" class="displayHide">
    <tr>
        <td>
            <a type="button" class="update-btn" href="./?advanceManage">Back</a>
        </td>
        <td>
    ...
    <thead>
        ...
        <tr>
            <th style="text-align: left">
                ...
                <span>Date : <?php echo date('Y-m-d h:i a'); ?></span><br>
...
<table style="width: 8cm; border: 1px solid black; font-weight: bold" class="tbl_border">
    ...
    <tr>
        <td style="text-align: right; padding-right: 5px;  width: 5cm">Received Amount :</td>
        <td style="text-align: right; padding-right: 5px;  width: 3cm"><?php echo $recAmt; ?></td>
    </tr>
    <tr>
        <td style="text-align: right; padding-right: 5px;  width: 5cm">Balance :</td>
        <td style="text-align: right; padding-right: 5px;  width: 3cm"><?php echo $balance; ?></td>
    </tr>
    <tr>
        <td></td>
