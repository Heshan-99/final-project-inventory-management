...
<html lang="en">
    ...
    <body>
            ...
            <div class="main--content">
                ...
                <!--==============================================================================-->
                    <table cellspacing="5" class="table topform">
                        <thead >
                        <tr>
                            <th colspan="3"> <h1 class="mainHeading">Customer form</h1></th>
                        </tr>
                        </thead>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td class="tablebtn"><button class="my-save-btn" type="button" id="SaveCust">Save Customer Details</button>
                                <button class="update-btn d-none" type="button" id="updateCus">Update Customer Details</button>
                                <button class="my-del-btn" type="button" id="resetCust">Clear Form</button></td>
                        </tr>
                    </table>
                    <br>
                    ...
                    <!--==============================================================================-->
                           ...
                           <div class="bottomTable">
                               <table cellspacing="0" cellpadding="5" id="addedCus_tbl" class="table">
                            <thead>
                            <tr>
                                <th colspan="6"> <h1>All Customer details</h1></th>
                            </tr>
                            <tr>
                                <th colspan="6">
                                    <div class="searchbox">
        ...
        <script type="text/javascript" src="./controllers/cust_controller.js"></script>
    </body>
</html>
